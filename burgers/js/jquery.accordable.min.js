;(function($){$.fn.accordable=function(options){var defaults=$.extend({openPanel:[],openAll:false,closeAll:true,speed:300,easing:'swing',addClasses:true,onLoad:function(){},beforeToggle:function(){},afterToggle:function(){}},options);return this.each(function(){var accordion=$(this),panel=accordion.children('li'),heading=panel.children('span'),expander=panel.children('div');accordion.css({listStyle:'none',margin:'0px',padding:'0px'});heading.css({cursor:'pointer',display:'block'});if(defaults.addClasses==true){accordion.addClass('accordable');panel.addClass('accordable-panel');heading.addClass('accordable-heading');expander.addClass('accordable-expander');}
